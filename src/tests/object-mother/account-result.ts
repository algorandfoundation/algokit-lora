  ...
  ['mainnet-JY2FRXQP7Q6SYH7QE2HF2XWNE644V6KUH3PYC4SYWPUSEATTDJSNUHMHR4']: () => {
    return new AccountResultBuilder({
      ...
      assets: [
        ...
        { amount: 1000000000000000000n, 'asset-id': 1205372113, 'is-frozen': false },
        { amount: 1000000000000000000n, 'asset-id': 1205372555, 'is-frozen': false },
        { amount: 1000000000000000000n, 'asset-id': 1205372814, 'is-frozen': false },
      ],
      'created-apps': [],
      'created-assets': [
        {
