        ...
        ...(b.upgradeState
          ? {
              upgradeState: {
                ...
                nextProtocolApprovals: b.upgradeState.nextProtocolApprovals ?? 0,
                nextProtocolSwitchOn: b.upgradeState.nextProtocolSwitchOn ?? 0,
                nextProtocolVoteBefore: b.upgradeState.nextProtocolVoteBefore ?? 0,
              },
            }
          : undefined),
        ...(b.upgradeVote
