...
export function TransactionsGraph({ transactionsGraphData }: Props) {
  ...
  return (
    <>
      <div className={cn('relative overflow-y-auto')} ref={visualRef}>
        {/* Don't change this id value, it's used by a bot Alessandro is building. */}
        <div id="visual-transactions" className="w-min bg-card" aria-label="Visual representation of transactions">
          <div
      ...
      <Button className={cn('absolute bottom-4 right-4 z-auto w-32 md:flex')} variant="outline" onClick={downloadImage}>
