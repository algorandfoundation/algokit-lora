...
export const arc89ControllerAppIdLabel = 'Controller App ID'
export const arc89CirculatingSupplyLabel = 'Circulating Supply'
export const arc89BurnedSupplyLabel = 'Burned Supply'
