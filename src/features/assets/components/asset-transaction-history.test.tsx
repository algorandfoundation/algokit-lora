...
import { mockSearchAssetTransactions } from '@/tests/setup/mocks'
...
describe('asset-transaction-history', () => {
  ...
  it('should run', () => {
    ...
    vi.mocked(indexer.searchForTransactions().assetID(asset.index).nextToken('').limit(DEFAULT_FETCH_SIZE).do).mockImplementation(() => {
