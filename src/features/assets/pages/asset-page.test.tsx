          ...
          await waitFor(() => {
            ...
            descriptionListAssertion({
              ...
              items: [
                ...
                { term: assetTotalSupplyLabel, description: '4,000,000 ORA' },
          ...
          await waitFor(() => {
            ...
            descriptionListAssertion({
              ...
              items: [
                ...
                { term: assetTotalSupplyLabel, description: '10,000,000,000 ALGO' },
          ...
          await waitFor(() => {
            ...
            descriptionListAssertion({
              ...
              items: [
                ...
                { term: assetTotalSupplyLabel, description: '10,000,000,000 FRACC' },
                { term: assetDecimalsLabel, description: '0' },
                { term: assetDefaultFrozenLabel, description: 'No' },
