  ...
  const tabs = useMemo(
    () => [
      ...
      },
      {
        ...
        children: <AccountApplicationsCreated applicationsCreated={account.applicationCreated} />,
      },
      {
    ...
    [account.address, account.applicationCreated, account.assetsCreated, account.assetsHeld, account.assetsOpted]
  )
  return (
